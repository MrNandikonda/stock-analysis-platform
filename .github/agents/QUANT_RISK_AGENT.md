...
Use this with `.github/instructions/quant-risk.instructions.md`.
...
- Conservative AI confidence when data is stale, sparse, missing, fallback, synthetic, or contradictory.
