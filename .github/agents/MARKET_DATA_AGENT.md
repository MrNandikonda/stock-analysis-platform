...
Use this with `.github/instructions/market-data.instructions.md`.
...
- `MarketService.search_symbol` validates potential NSE and US symbols.
...
- US options are parsed through yfinance into the existing options-row shape.
...
- Coordinate with DEVOPS_DOCKER for dependency additions or image build issues.
